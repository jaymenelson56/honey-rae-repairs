    ...
    return (
        <section className="ticket" >
            ...
            <footer>
                ...
                <div>
                    <div className="ticket-info">date completed</div>
                    <div>{ticket.dateCompleted === "" ? "Pending": ticket.dateCompleted } </div>
                </div>
                <div>
                ...
                <div className="btn-container">
                    ...
                    {assignedEmployee?.userId === currentUser.id && !ticket.dateCompleted ? (<button className="btn btn-warning" onClick={handleClose}>
                        Close</button>
                    ) : ("")
                    }
